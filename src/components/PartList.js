...
function PartList({total, handleSelect}) {
  return (
    <div className= 'partListWrapper'> 
            ...
            <div className='partList' id="clothing1"  ><h4 className='partListName'>clothing1  </h4><PartItems handleSelect = {handleSelect} count={total["clothes/layer_1"]} type= "clothes/layer_1" /></div>
            <div className='partList' id="clothing2"  ><h4 className='partListName'>clothing2  </h4><PartItems handleSelect = {handleSelect} count={total["clothes/layer_2"]} type= "clothes/layer_2" /></div>
            <div className='partList' id="clothing3"  ><h4 className='partListName'>clothing3  </h4><PartItems handleSelect = {handleSelect} count={total["clothes/layer_3"]} type= "clothes/layer_3" /></div>
          </div>
  )
}
